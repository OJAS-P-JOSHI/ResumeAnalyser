...
resume_videos = ['https://youtu.be/3agP4x8LYFM','https://youtu.be/fS_t3yS8v5s',
                 ...
                 'https://youtu.be/BdQnilI4xMU','https://youtu.be/bhwEsfXS6y8']

interview_videos = ['https://youtu.be/Tt08KmFfIYQ','https://youtu.be/KukmClH1KoA',
                    'https://youtu.be/7_aAERyw8I','https://youtu.be/Tt08KmFfIYQ',
                 'https://youtu.be/CLUspicmPB3A','https://youtu.be/1mHjMNZZvFo',
